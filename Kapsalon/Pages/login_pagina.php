...
<body>
    ...
    <!-- Main content with bg-green -->
    <div class="bg-green text-dark py-5">
        <div class="container">
                ...
                <div class="col-md-6 mt-4 mb-4">
                    ...
                    <div class="card shadow-sm p-4">
                        ...
                        <div class="container">
                            ...
                            <form action="login/login.php" method="post" id="loginForm">
                                <div class="form-group mb-3">
                                    <label for="gebruikersnaam" class="text-dark">Email address or username</label>
                                    <input type="text" class="form-control custom-focus" id="gebruikersnaam" name="gebruikersnaam" required>
                                </div>

                                <div class="form-group mb-3">
                                    <label for="wachtwoord" class="text-dark">Password</label>
                        ...
                        <div class="text-center my-3">
                            <span class="text-dark">Or continue with</span>
